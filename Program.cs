...
*/
        ...
        //     Implementação da Compra/Venda do ILoja - FastFood e SelfService
            ...
            // Cliente cliente1 = new Cliente("Denis", "4532154");
            ...
            // Aeronave boeing777 = new Aeronave("boeing 777", "PR988");
            // Bagagem bolsa = new Bagagem(55,"bolsa de mao");
            // Passageiros Denis = new Passageiros("Denis", "123456");
            // Passagem bh = new Passagem(Denis, boeing777, 22, "BH", 500);
            // Guiche latam = new Guiche("Latam", bh,  bolsa);
            // latam.Vender();
